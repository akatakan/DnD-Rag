  ...
  return (
    <main className="dm-layout" id="main-content">
      ...
      <section className="dm-center">
        ...
        <MapWorkspace initialScene={snapshot.map_scene} gameRevision={snapshot.revision} token={token} canControl={canControl} activeCombatantId={current?.id} onError={onError} portraits={snapshot.portraits} />
